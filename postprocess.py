...
main p,.toggle-body p{margin:0 0 12px;line-height:1.75}main p+p,.toggle-body p+p{margin-top:6px}main br,.toggle-body br{line-height:1.75}main h2{margin-top:2.1em;margin-bottom:.75em}main h3{margin-top:1.8em;margin-bottom:.65em}main hr{margin:22px 0}.toggle-body{padding-top:12px;padding-bottom:8px}.toggle-body ul,.toggle-body ol{margin-top:8px;margin-bottom:14px}.toggle-body li{margin:4px 0;line-height:1.7}
.quote-group{margin:18px 0 22px;padding-left:16px;border-left:4px solid #ff3f8e}.quote-group blockquote{margin:0;padding:0;border:0}.quote-group p{margin:8px 0 0;padding:0;line-height:1.75}.cs-tags{line-height:1.9;margin-top:8px!important;margin-bottom:18px!important}
